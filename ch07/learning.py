...
import os  # noqa
from common.util import im2col, col2im  # noqa
...
class SimpleConvNet:
    def __init__(self,
        ...
        input_size = input_dim[1]  # なんの変数? -> connv_output_size を計算するために使うinput 画像の1辺のサイズ
        conv_output_size = (input_size - filter_size + 2 * filter_pad) / \
            filter_stride + 1
        pool_output_size = int(filter_num * (conv_output_size / 2) *
                               (conv_output_size / 2))  #  なぜこんな計算になる? -> テンソル対応
